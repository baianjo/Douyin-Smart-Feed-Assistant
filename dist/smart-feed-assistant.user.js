...
(function() {
    ...
    const CONFIG = {
        ...
        templates: {
            '青少年内容引导': {
                like: '系统讲解科学、技术、历史、地理、商业等领域知识，构建知识体系；展示专业技能（如摄影、编程、设计、乐器）的学习实践过程，体现创造的乐趣与挑战；对国内外时事与社会现象进行有理有据的逻辑分析，提供多元视角，培养独立思考与国际视野；展现顶尖学府的校园、学术、科研或学生生活经验，探讨职业规划与个人成长；高质量航拍、风光摄影、人文纪录片，展现自然壮丽与文化厚重，培养审美与家国情怀；内容体现高度自律、家庭与社会责任感、人文关怀及良好金钱观。',
                neutral: '不含强烈价值观输出的日常生活记录(Vlog)、萌宠、美食探店、旅行流水账。不含攻击性、不涉及争议话题的普通新闻资讯或信息播报。展现非专业、纯娱乐性质的才艺表演（如非低俗的唱歌、乐器弹奏等）。',
                dislike: '纯粹玩梗、内容混乱、逻辑缺失、没有信息增量的抽象视频，以及故意制造降智效果的恶搞内容；无节制地宣扬消费主义、奢侈品、炫富、比拼物质，以及大部分纯粹以卖货为目的的带货片段；长时间、纯娱乐、易上瘾的游戏直播/录播；宣扬或展现不尊重长辈、师长，哗众取宠、恶意捉弄他人，传播负面情绪、制造性别对立或社会矛盾的内容；包含性暗示、观感不适的舞蹈、低俗笑话。'
            },
            '效率与知识': {
