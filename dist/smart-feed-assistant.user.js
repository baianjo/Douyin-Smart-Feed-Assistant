...
(function() {
    ...
    const CONFIG = {
        ...
        templates: {
            '青少年内容引导': {
                like: '系统性地讲解科学、技术、历史、地理、商业等领域的知识，能够构建完整的知识体系；展示一项专业技能（如摄影、编程、设计、工程、乐器演奏）的学习或实践过程，揭示从创意到成品的完整链路，展现创造的乐趣与挑战；对国内外时事、社会现象进行有理有据的逻辑分析，提供多元视角，培养独立思考能力，拓宽国际视野；展现国内外顶尖学府的校园环境、学术氛围、科研项目或优秀学生的学习生活经验分享，探讨未来职业规划与个人成长路径；高质量的航拍、风光摄影、人文纪录片，展现山川湖海的壮丽和历史文化的厚重，培养审美情趣和家国情怀；内容中体现出高度的自律精神、对家庭和社会的责任感、以及在团队项目中有效协作解决问题的过程。',
