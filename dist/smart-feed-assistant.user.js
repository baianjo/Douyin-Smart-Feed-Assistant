...
(function() {
    ...
    const CONFIG = {
        ...
        templates: {
            '青少年内容引导': {
                like: '深度知识与体系化学习：系统性地讲解科学、技术、历史、地理、商业等领域的知识，能够构建完整的知识体系，而不仅仅是零散的“冷知识”。专业技能与创造过程：展示一项专业技能（如摄影、编程、设计、工程、乐器演奏）的学习或实践过程，揭示从创意到成品的完整链路，展现创造的乐趣与挑战。逻辑思辨与开阔视野：对国内外时事、社会现象进行有理有据的逻辑分析，提供多元视角，培养独立思考能力，拓宽国际视野。名校风采与未来展望：展现国内外顶尖学府的校园环境、学术氛围、科研项目或优秀学生的学习生活经验分享，探讨未来职业规划与个人成长路径。自然之美与人文景观：高质量的航拍、风光摄影、人文纪录片，展现山川湖海的壮丽和历史文化的厚重，培养审美情趣和家国情怀。自律、责任与团队协作：内容中体现出高度的自律精神、对家庭和社会的责任感、以及在团队项目中有效协作解决问题的过程。',
                neutral: '不含强烈价值观输出的日常生活记录(Vlog)、萌宠、美食探店、旅行流水账。不涉及攀比炫耀、不鼓吹消费的普通开箱、产品体验视频。不含攻击性、不涉及争议话题的普通新闻资讯或信息播报。展现非专业、纯娱乐性质的才艺表演（如非低俗的唱歌、乐器弹奏等）。',
                dislike: '碎片化与反智内容：纯粹玩梗、内容混乱、逻辑缺失、没有信息增量的“抽象”视频，以及故意制造降智效果的恶搞内容。鼓吹消费与炫耀攀比：无节制地宣扬消费主义、奢侈品，通过炫富、比拼物质来制造焦虑，以及大部分纯粹以卖货为目的的直播带货片段。沉溺型娱乐内容：长时间、纯娱乐、易上瘾的游戏直播/录播，特别是那些内容重复性高、缺乏技巧和策略展示的。负面情绪与不良关系：宣扬或展现不尊重长辈、师长，哗众取宠、恶意捉弄他人，传播负面情绪、制造性别对立或社会矛盾的内容。低俗与擦边球内容：包含性暗示、观感不适的舞蹈、低俗笑话。'
            },
            '效率与知识': {
