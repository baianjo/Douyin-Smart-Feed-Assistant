...
(function() {
    ...
    const CONFIG = {
        ...
        templates: {
            '小学内容引导': {
                like: '趣味生动的STEM科普、历史故事，启发学习兴趣与好奇心；展现中国普通劳动者的奉献，或适合小学生同情的感人的家庭、师生、同学、社会百态、家国情谊、乡土情结；分享小升初的经验、名校风光、为什么学习等正面话题；培养自律、诚信、爱护家人、尊重他人的品格；展现自然风光、创意手工、小学生健康运动，培养审美与动手能力；学习良好的价值观和金钱观。',
