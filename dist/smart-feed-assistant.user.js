...
(function() {
    ...
    const CONFIG = {
        ...
        templates: {
            '小学内容引导': {
                like: '趣味生动的STEM科普、历史故事，启发学习兴趣与好奇心；展现中国普通劳动者的创造与奉献，或感人的家庭、师生、同学、家国情谊；分享小升初的经验、名校风光、为什么要学习等正面话题；培养自律、诚信、爱护家人、尊重他人的良好品格；展现自然风光、创意手工、小学生健康运动，培养审美与动手能力；学习良好的金钱观。',
                neutral: '不含强烈价值观输出的日常生活记录、萌宠、美食、旅行片段；非低俗的唱歌、乐器弹奏等才艺表演；非暴力、非上瘾的益智类或创意类游戏短视频。',
                dislike: '无意义的玩梗、降智恶搞；炫富攀比、宣扬过度消费；展现不尊重长辈、师长，恶意捉弄他人，或传播负面情绪的内容；易上瘾的长时间游戏直播/录播；包含暴力、低俗、性暗示的内容。'
            },
            '中学内容引导': {
                ...
                neutral: '不含强烈价值观输出的日常生活Vlog、美食探店、旅行记录；不含攻击性、不涉及争议话题的普通新闻资讯；非专业、纯娱乐性质的才艺表演。',
                dislike: '纯粹玩梗、逻辑缺失的抽象内容；无节制宣扬消费主义、炫富；长时间、易上瘾的游戏直播/录播；传播负面情绪、制造性别对立或社会矛盾；包含性暗示、观感不适的舞蹈、低俗笑话。'
            },
            '效率与知识': {
